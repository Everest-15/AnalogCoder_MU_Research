...
data_path = '../data_files/problem_set.tsv'
...
def output_retrieval_prompt(output_df):
    retrieval_template = open("../templates/retrieval_prompt_template.md", "r").read()
    ...
    with open("../data_files/retrieval_prompt.md", "w") as f:
